...
namespace IC02_kmg_SportsPro.Migrations
{
    ...
    [Migration("20230129150005_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IC02_kmg_SportsPro.Models.Country", b =>
                {
            ...
            modelBuilder.Entity("IC02_kmg_SportsPro.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("IC02_kmg_SportsPro.Models.Incident", b =>
                {
            ...
            modelBuilder.Entity("IC02_kmg_SportsPro.Models.Product", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IC02_kmg_SportsPro.Models.Technician", b =>
                {
                    b.Property<int>("TechnicianID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IC02_kmg_SportsPro.Models.Customer", b =>
                {
                    b.HasOne("IC02_kmg_SportsPro.Models.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("IC02_kmg_SportsPro.Models.Incident", b =>
                {
                    b.HasOne("IC02_kmg_SportsPro.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IC02_kmg_SportsPro.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IC02_kmg_SportsPro.Models.Technician", "Technician")
                        .WithMany()
